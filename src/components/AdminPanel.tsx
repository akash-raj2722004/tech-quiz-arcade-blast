...
const AdminPanel: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col gap-6 w-full ${isFullscreen ? 'fixed top-0 left-0 w-full h-full z-50 bg-black p-4' : ''}`}>
      ...
      <div className={`arcade-panel min-h-[200px] md:min-h-[300px] flex flex-col items-center justify-center ${isFullscreen ? 'flex-grow' : ''}`}>
          ...
          {currentImage ? (
            <div className="text-center">
              <img 
                ...
                className={`rounded-lg object-contain ${isFullscreen ? 'max-h-[60vh]' : 'max-h-[250px]'}`}
                onError={(e) => {
